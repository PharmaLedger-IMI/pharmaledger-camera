export const sessionPresetNames = [
    "low",
    "medium",
    "high",
    "inputPriority",
...
export function getBridgeServerUrl() {
    return _serverUrl;
}
 ...
 */
export function startNativeCamera(sessionPresetName, flashMode, onFramePreviewCallback = undefined, targetPreviewFps = 25, previewWidth = 640, onFrameGrabbedCallBack = undefined, targetGrabFps = 10, auto_orientation_enabled=false, onCameraInitializedCallBack = undefined, x=undefined, y=undefined, w=undefined, h=undefined, ycbcr=false) {
    ...
    let params = {
        "onInitializedJsCallback": `window.${onNativeCameraInitialized.name}`,
        "sessionPreset": sessionPresetName,
        "flashMode": flashMode,
        "previewWidth": _previewWidth,
        "auto_orientation_enabled": auto_orientation_enabled
    }
    window[`${onNativeCameraInitialized.name}`] = onNativeCameraInitialized;
 ...
 * @param  {number} h
 */
export function setRawCropRoi(x, y, w, h) {
    _x = x;
    _y = y;
    _w = w;
    _h = h;
 ...
 */
export function takePictureBase64NativeCamera(onCaptureCallback) {
 ...
 */
export function setFlashModeNativeCamera(mode) {
 ...
 */
export function setTorchLevelNativeCamera(level) {
 ...
 */
export function setPreferredColorSpaceNativeCamera(colorspace) {
    callNative("SetPreferredColorSpace", { "colorspace": colorspace })
}

export function onNativeCameraInitialized(wsPort) {
 ...
 */
export function getRawFrame(x = undefined, y = undefined, w = undefined, h = undefined) {
 ...
 */
export function getRawFrameYCbCr(x = undefined, y = undefined, w = undefined, h = undefined) {
